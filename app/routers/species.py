...
@router.post("/{specie_name}", tags=["animal"], status_code=status.HTTP_204_NO_CONTENT, response_model=None)
async def update_animal(
	...
	update_specie_service(db=db, specie_name=specie_name, specie=specie)
	return